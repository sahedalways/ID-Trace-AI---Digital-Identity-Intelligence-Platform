            ...
            <div class="space-y-3">
                ...
                ?>
                    <div class="relative">
                        ...
                        <label for="embed_plan_<?php echo $code; ?>" class="plan-card-wrapper border border-gray-200 rounded-xl p-4 flex flex-col cursor-pointer hover:border-gray-300 transition-all bg-white block relative select-none space-y-3">
                                ...
                                <div class="flex items-center gap-3.5 min-w-0">
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <div class="text-xs text-black font-medium mt-0.5">
                                            ...
                                            <span class="text-gray-700 font-semibold">$<?php echo number_format($plan['price'], 0); ?> <?php echo htmlspecialchars($meta['billing_text']); ?></span>
                                        </div>
                                    </div>
                                </div>
