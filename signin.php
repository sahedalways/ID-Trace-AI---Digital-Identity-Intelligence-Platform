...
<body class="min-h-screen flex flex-col justify-between selection:bg-[#0072bc] selection:text-white bg-slate-50 relative">
    ...
    <main class="w-full mx-auto max-w-[440px] px-6 py-12 flex-grow flex flex-col justify-center fade-in-up">
        ...
        <div id="stageIdentityBlock" class="block space-y-6">
            ...
            <div class="relative flex items-center my-6"><div class="flex-grow border-t border-blue-200"></div><span class="flex-shrink mx-3 text-xs text-blue-400 font-normal lowercase">or</span><div class="flex-grow border-t border-blue-200"></div></div>

            <a href="<?php echo htmlspecialchars($google_auth_url); ?>" class="w-full bg-white hover:bg-gray-50 text-gray-800 font-bold py-3.5 px-4 rounded-xl border border-blue-200 shadow-sm transition text-[15px] flex items-center justify-center gap-2.5 group">
