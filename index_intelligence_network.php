...
<section class="w-full max-w-[1600px] mx-auto px-4 sm:px-6 py-10 md:py-16 relative overflow-hidden">
    ...
    <!-- Section Header -->
    <div class="text-center max-w-2xl mx-auto mb-10 sm:mb-16 animate-on-scroll">
    ...
    <div class="sm:hidden animate-on-scroll">
        <!-- Central Profile Card -->
        <div class="flex justify-center mb-5">
            <div class="relative">
                <div class="absolute inset-0 rounded-full bg-[#0072bc]/20 blur-2xl animate-pulse"></div>
                <div class="relative w-20 h-20 rounded-full bg-gradient-to-br from-[#0072bc] to-blue-600 border-4 border-white shadow-[0_20px_60px_rgba(0,114,188,0.4)] flex flex-col items-center justify-center text-white">
                    <span class="text-xl font-black">JC</span>
                    <span class="text-[8px] font-bold text-blue-100 mt-0.5">John Carter</span>
                </div>
                <div class="absolute -bottom-1 -right-1 w-7 h-7 rounded-full bg-green-500 border-2 border-white flex items-center justify-center shadow-md">
        ...
        <div class="grid grid-cols-2 gap-2.5">
            <!-- Social -->
            <div class="bg-white/90 backdrop-blur rounded-2xl border border-blue-100 shadow-lg shadow-blue-100/40 p-3 flex items-center gap-2.5">
                <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 text-white flex items-center justify-center shrink-0">
                    <i class="fa-solid fa-users text-sm"></i>
                </div>
                <div>
                    <p class="text-[9px] text-gray-400 font-bold uppercase tracking-wide">Social</p>
            ...
            <!-- Web -->
            <div class="bg-white/90 backdrop-blur rounded-2xl border border-blue-100 shadow-lg shadow-blue-100/40 p-3 flex items-center gap-2.5">
                <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-teal-500 to-teal-600 text-white flex items-center justify-center shrink-0">
                    <i class="fa-solid fa-comment-dots text-sm"></i>
                </div>
                <div>
                    <p class="text-[9px] text-gray-400 font-bold uppercase tracking-wide">Web</p>
            ...
            <!-- Related -->
            <div class="bg-white/90 backdrop-blur rounded-2xl border border-blue-100 shadow-lg shadow-blue-100/40 p-3 flex items-center gap-2.5">
                <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-cyan-500 to-cyan-600 text-white flex items-center justify-center shrink-0">
                    <i class="fa-solid fa-user-group text-sm"></i>
                </div>
                <div>
                    <p class="text-[9px] text-gray-400 font-bold uppercase tracking-wide">Related</p>
            ...
            <!-- Records -->
            <div class="bg-white/90 backdrop-blur rounded-2xl border border-blue-100 shadow-lg shadow-blue-100/40 p-3 flex items-center gap-2.5">
                <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-purple-500 to-purple-600 text-white flex items-center justify-center shrink-0">
                    <i class="fa-solid fa-folder-open text-sm"></i>
                </div>
                <div>
                    <p class="text-[9px] text-gray-400 font-bold uppercase tracking-wide">Records</p>
            ...
            <!-- Usernames -->
            <div class="bg-white/90 backdrop-blur rounded-2xl border border-blue-100 shadow-lg shadow-blue-100/40 p-3 flex items-center gap-2.5">
                <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-indigo-500 to-indigo-600 text-white flex items-center justify-center shrink-0">
                    <i class="fa-solid fa-at text-sm"></i>
                </div>
                <div>
                    <p class="text-[9px] text-gray-400 font-bold uppercase tracking-wide">Usernames</p>
            ...
            <!-- Emails -->
            <div class="bg-white/90 backdrop-blur rounded-2xl border border-blue-100 shadow-lg shadow-blue-100/40 p-3 flex items-center gap-2.5">
                <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-rose-500 to-rose-600 text-white flex items-center justify-center shrink-0">
                    <i class="fa-solid fa-envelope text-sm"></i>
                </div>
                <div>
                    <p class="text-[9px] text-gray-400 font-bold uppercase tracking-wide">Emails</p>
            ...
            <!-- Risk -->
            <div class="bg-white/90 backdrop-blur rounded-2xl border border-blue-100 shadow-lg shadow-blue-100/40 p-3 flex items-center gap-2.5">
                <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-amber-500 to-orange-600 text-white flex items-center justify-center shrink-0">
                    <i class="fa-solid fa-triangle-exclamation text-sm"></i>
                </div>
                <div>
                    <p class="text-[9px] text-gray-400 font-bold uppercase tracking-wide">Risk</p>
            ...
            <!-- Locations -->
            <div class="bg-white/90 backdrop-blur rounded-2xl border border-blue-100 shadow-lg shadow-blue-100/40 p-3 flex items-center gap-2.5">
                <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-amber-500 to-amber-600 text-white flex items-center justify-center shrink-0">
                    <i class="fa-solid fa-location-dot text-sm"></i>
                </div>
                <div>
                    <p class="text-[9px] text-gray-400 font-bold uppercase tracking-wide">Locations</p>
    ...
    <div class="hidden sm:block relative max-w-4xl mx-auto animate-on-scroll">
    ...
    <!-- Bottom note -->
    <div class="text-center mt-8 sm:mt-10 animate-on-scroll">
