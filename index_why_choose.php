<?php
/**
 * Identity Search AI — Why People Choose Section
 * File: index_why_choose.php
 * Large numbers with supporting text for key differentiators.
 */
?>
<section class="w-full max-w-[1600px] mx-auto px-4 sm:px-6 py-10 md:py-16 relative overflow-hidden">
    <!-- Background decorations -->
    <div class="absolute inset-0 -z-10 pointer-events-none">
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[500px] bg-gradient-to-r from-[#0072bc]/5 via-blue-50/20 to-[#0072bc]/5 rounded-full blur-3xl"></div>
    </div>
    ...
    <div class="text-center max-w-2xl mx-auto mb-12 sm:mb-16 animate-on-scroll">
        ...
        <h2 class="mt-5 text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 tracking-tight leading-tight">
            Why People Choose Identity Search AI
        </h2>

        <p class="mt-3 text-xs sm:text-sm text-gray-500 font-medium leading-relaxed">
            Built for speed, accuracy, and clarity — here's what makes our intelligence platform different.
        </p>
    </div>
