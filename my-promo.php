            ...
            <?php if (empty($promos)): ?>
                <div class="p-12 border border-dashed border-gray-200 rounded-2xl text-center space-y-3 bg-white">
                    ...
                    <div class="space-y-1">
                        ...
                        <p class="text-xs font-semibold text-gray-800 max-w-xs mx-auto">Purchase a credit subscription layer framework to automatically unlock promotional platform credentials.</p>
                    </div>
                </div>
            <?php else: ?>
